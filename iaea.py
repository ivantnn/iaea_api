...
class chain_finder:
	...
	def find_daughters(self):
		...
		x_1 = df['decay_1'].fillna(' ').values
		x_2 = df['decay_2'].fillna(' ').values
		x_3 = df['decay_3'].fillna(' ').values
